...
export default function AppSidebar() {
  ...
  return (
    <aside
      ...
      className="fixed left-0 top-0 h-screen bg-sidebar border-r border-sidebar-border flex flex-col z-50 transition-[width] duration-200"
    >
      {/* Logo */}
      ...
      <button
        ...
        className="h-11 flex items-center justify-center border-t border-sidebar-border text-muted-foreground hover:text-foreground transition-colors"
      >
